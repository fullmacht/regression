...
# predict_y_test_data = y_submit[predict_value_comlumn_name_y_submit]
...
# pred_val_y_submit_series = y_submit[predict_value_comlumn_name_y_submit]
# time_column_y_test_series = y_test[predict_value_comlumn_name_y_test]


# индексы всех значений
# all_indices_y_test = pd.Index(pred_val_y_submit_series)
...
# y_train_shifted = time_column_y_train_series.shift(1)
...
# y_submit_finish_time_and_prep_values = y_submit_finish_time_values.append(last_pred_value_y_submit_df,ignore_index=True)

y_train = y_train_without_first_value_shifted
# last_index_match_y_test_in_x_test_finish = y_train_full
...
# y_test_finish = y_test_without_first_value_shifted
# print(y_test_finish)
# print(y_submit_finish.shape)
# y_submit_y_test = y_train_full
# print(y_submit_finish)
# print(y_train_finish.shape,'y_train_fin')
# print(y_train_finish,'y_train_fin')
# print(x_train_finish.shape,'x_train_fin')
# print(y_test_finish.shape,'y_test_fin')
# print(x_test_finish.shape,'x_test_fin')
# y_test =y_submit_y_test
